...
# every number is a prime so the mcd is the multp of all of them
...
for i in range(10000):
    for monkey in range(len(monkeys)):
        for item in monkeys[monkey]['starting']:
            ...
            item %= mod  # the number itself is not neccessary but the common rest which is the rest of the division with the mcd
